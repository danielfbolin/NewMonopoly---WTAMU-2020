...
public class Dice : MonoBehaviourPun {
	...
	void Start()
	{
        ...
        rb.useGravity = true;
        initPosition = new Vector3(-6.0f, 0.23f, -7.0f);
        fallPosition = new Vector3(-4.5f, 3.0f, -5.0f);
        initRotation = rb.rotation;
        hasLanded = false;
        //Debug.Log("Dice1 in spawn position");
	}
    ...
    public void SideValueCheck()
	{
		...
		foreach (DiceSide side in diceSides)
		{
			if (side.OnGround())
			{
                ...
                //Debug.Log("Dice 1 value: " + diceValue);
			}
		}
	}
}
